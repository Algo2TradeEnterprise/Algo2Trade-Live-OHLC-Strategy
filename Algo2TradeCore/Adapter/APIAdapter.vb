...
#End Region
        ...
        Public Sub New(ByVal associatedParentController As APIStrategyController,
            ...
            _cts = canceller
        End Sub
        Public MustOverride Function CalculatePLWithBrokerage(ByVal stockName As String, ByVal buy As Double, ByVal sell As Double, ByVal quantity As Integer, ByVal exchange As String) As Decimal
